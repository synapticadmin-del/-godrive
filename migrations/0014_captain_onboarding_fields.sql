-- 0014: Captain onboarding profile fields
--
-- The four-step captain onboarding (personal info → driving licence →
-- personal documents → vehicle info) collects more than the original schema
-- could hold: the four-part Arabic name, date of birth, national ID number,
-- licence expiry date and vehicle year. All nullable — existing captain rows
