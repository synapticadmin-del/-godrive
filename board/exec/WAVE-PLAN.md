...
| 1 | **E16** | `apps/api/src/routes/user.ts` · `migrations/@NEXT_consent_and_deletion.sql` · `docs/legal/` · `apps/rider/lib/screens/profile/settings_screen.dart` · `apps/captain/lib/screens/profile/settings_screen.dart` |
